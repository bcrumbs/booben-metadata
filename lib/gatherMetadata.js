...
const { isValidValue, printType, isBuiltinType } = require('booben-types');
 ...
 * @param {BoobenTypeDefinition} typedef
 * @param {Object<string, Object<string, string>>} strings
 * @param {Object<string, Object>} types
 * @param {string} componentName
 * @throws {Error}
 ...
 * @param {Object<string, Object<string, string>>} strings
 * @param {string} componentName
 * @return {Promise<Object<string, BoobenTypeDefinition>>}
 */
...
module.exports = moduleDir => co(function* () {
  ...
  if (!mainMeta) {
    ...
    mainMeta = packageJSON.booben;
  }
  
  if (!mainMeta) throw new Error('Not a booben components library');
