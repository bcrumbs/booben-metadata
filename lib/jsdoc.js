...
/**
 * @typedef {Object} ComponentMeta - Component metadata (root object in .booben/meta.json files).
 ...
 * @property {string} [icon] - Icon file name (icon must be placed in .booben/icons dir).
 ...
 * @property {Object<string, Object<string, string>>} [strings] - String translations. Example: { "string_key": { "en": "...", "ru": "...", ... }, ... }. Can be placed in a separate file (.booben/strings.json).
 * @property {Object<string, BoobenValueDefinition>} [types] - User-defined types. Can be placed in a separate file (.booben/types.json).
 */
...
/**
 * @typedef {BoobenTypeDefinition} ComponentStateSlot
...
/**
 * @typedef {BoobenTypeDefinition} ComponentMethodArgument
 * @property {string} textKey
 * @property {string} descriptionTextKey
...
/**
 * @typedef {BoobenTypeDefinition} BoobenValueDefinition
...
/**
 * @typedef {BoobenValueDefinition} ComponentPropMeta
...
/**
 * @typedef {BoobenValueDefinition} ActionArgumentDefinition
 * @property {string} textKey
 * @property {string} descriptionTextKey
 */
...
/**
 * @typedef {BoobenTypeDefinition} DesignerSourceConfigPropDesc
 * @property {string} textKey
